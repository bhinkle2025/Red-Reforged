...
.Text:
	text_far _ViridianCityFishingGuruText
	text_end

.ReceivedGoodRodText:
	text_far _ViridianCityFishingGuruReceivedGoodRodText
	sound_get_item_1
	text_end

.ThatsSoDisappointingText:
	text_far _ViridianCityFishingGuruThatsSoDisappointingText
	text_end

.HowAreTheFishText:
	text_far _ViridianCityFishingGuruHowAreTheFishText
	text_end

.NoRoomText:
	text_far _ViridianCityFishingGuruNoRoomText
	text_end
