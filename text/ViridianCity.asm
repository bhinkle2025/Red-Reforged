...
_ViridianCityFishingGuruReceivedGoodRodText::
	text "Grand! I like"
	line "your style!"
...
_ViridianCityFishingGuruThatsSoDisappointingText::
	text "Oh... That's so"
	line "disappointing..."
	done

_ViridianCityFishingGuruHowAreTheFishText::
	text "Hello there,"
	line "<PLAYER>!"
...
_ViridianCityFishingGuruNoRoomText::
	text "Oh no!"
